...
* http://crystal-lang.org/[Crystal 0.18+]
...
.file::src/found-executable-p.cr
[source,crystal]
----
require "file"
...
Exits with code 0 if the file is an executable and found in the PATH environment variable and exits code 1 otherwise.
EOF
  if error
