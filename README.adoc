...
=== `zsh-user` - runs Zsh with the current user's environment
...
exec tdrop --monitor-aware term-emu zsh-user
...
exec tdrop --monitor-aware emacsclient-commander-for-dropdown
