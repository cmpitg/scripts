...
=== `with-inferno` - runs a command with Inferno OS environment
...
export INFERNO_OS_ROOT="${INFERNO_OS_ROOT:-/m/opt/inferno-os}"
...
switch $envName {
    ...
    guix -
    g {
        execl with-env-guix $args
    }
    ruby {
        execl with-chruby $args
    }
    python -
    conda -
    py {
    ...
    graalvm -
    graal {
        execl with-graalvm $args
    }
    inferno {
        execl with-inferno $args
    }
    default {
