...
===== `interactive/call-menu` - performs a high-level WM action

.file::wm/herbstluft/interactive/call-menu
[source,sh]
----
#!/usr/bin/env tclsh
...
set action [exec get-menu $menuName 2> /dev/null | run-context-menu]
...
proc callHC {args} {
    return [exec enrich-path guix - with-env herbstclient {*}$args]
}
...
===== `menus/get-menu <menu-name>`

TODO: assert argv

.file::wm/herbstluft/menus/get-menu
[source,sh]
----
#!/usr/bin/env tclsh
...
puts "(popup-menu [exec $menuName-menu])"

----

===== `menus/app-menu`

.file::wm/herbstluft/menus/app-menu
[source,sh]
----
...
.file::wm/herbstluft/menus/client-menu
[source,sh]
----
#!/usr/bin/env -S guile -s
# -*- mode: scheme -*-
...
.file::wm/herbstluft/menus/wm-menu
[source,sh]
----
#!/usr/bin/env -S guile -s
# -*- mode: scheme -*-
