...
TODO: `found-executable-p` shouldn't use `which`

TODO: Add `report-missing-executables <bin> <software> <bin> <software> ...`

TODO: Tryout Clib to bundle Plan9port with this repository

TODO: Make a script to update Elixir: https://github.com/elixir-lang/elixir/releases/

TODO: Make a script to update Racket

TODO: Make a script ot update Docker Compose and Docker Machine

TODO: Add development dependency: Nim
...
if ! found-executable-p gawk; then
	echo gawk not found. >&2
	echo Make sure you have GNU Awk installed. >&2
	exit 1
fi
...
if ! found-executable-p sed; then
	echo sed not found. >&2
	echo Make user you have GNU sed installed. >&2
	exit 1
fi
...
if ! found-executable-p tar; then
	echo tar not found. >&2
	echo Make user you have GNU Tar installed. >&2
	exit 1
fi
...
if ! found-executable-p mpstat; then
	echo mpstat not found >&2
	echo Make sure you have Sysstat installed >&2
	exit 1
fi
...
if ! found-executable-p tags ; then
	echo ctags not found >&2
	echo Make sure you have Ctags or Exuberant Ctags installed >&2
	exit 1
fi
...
if (! found-executable-p sbcl) {
	echo sbcl executable not found >[1=2]
	echo Make sure you have SBCL installed >[1=2]
	exit 1
}
if not {
...
if (! found-executable-p curl) {
	echo curl not found >[1=2]
	echo Make sure you have Curl installed >[1=2]
	exit 1
}
...
if (! found-executable-p lynx) {
	echo lynx not found. >[2=1]
	echo Make sure you have Lynx installed. >[2=1]
	exit 1
}
