...
Writes TODO[ASDF manifest] file to a location, set by environment variable
`manifest`.  By default, `manifest` is set to
`/m/config/common-lisp/sbcl-quicklisp-manifest.txt`.
...
=== `clojure-repl` - starts Clojure REPL with TODO[Lein]
